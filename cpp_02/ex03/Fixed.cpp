...
/*   Updated: 2023/07/31 14:56:10 by chris            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed::Fixed( float const n ) {
    ...
    if ( static_cast<int>(roundf(n * (1 << _fractional))) > 0 ) {
        ...
        // std::cout << RED << "Float Constructor: OverFlow: " << RESET << "result does not fit in 'float'" << std::endl;
        _integer = 0;
...
Fixed Fixed::operator+( Fixed const & rhs ) const {
    ...
    std::cout << " and " << this->toFloat() << RESET << std::endl;
